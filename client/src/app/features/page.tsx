...
const features = [
  {
    ...
    description: "Isolated ecosystem for each organization with complete data separation and customizable workflows.",
    icon: "🏢",
    details: [
  ...
  },
  {
    ...
    description: "Add/update items with automatic stock control, vendor linkage, and intelligent categorization.",
    icon: "📦",
    details: [
  ...
  },
  {
    ...
    description: "Complete logs of all replenishments, orders, and system changes with detailed timestamps.",
    icon: "📋",
    details: ["Complete audit trails", "Real-time change tracking", "Historical data analysis", "Compliance reporting"],
    color: "accent",
  },
  {
  ...
  },
  {
    ...
    description: "Register customers, track multiple orders, and gain valuable customer insights and analytics.",
    icon: "👥",
    details: [
  ...
  },
  {
    ...
    description: "Restricted access by roles including admin, stock manager, and sales with granular permissions.",
    icon: "👤",
    details: ["Role-based permissions", "Activity monitoring", "Performance tracking", "Team collaboration tools"],
    color: "chart-3",
  },
  {
    title: "Order Management",
    description: "Place orders with auto-decrement stock, snapshot pricing, and complete order history tracking.",
    icon: "🛒",
    details: [
  ...
  },
  {
    ...
    description: "Two-way tracking system showing which vendor supplied which item and which customer ordered what.",
    icon: "🔗",
    details: ["End-to-end traceability", "Supply chain visibility", "Quality control tracking", "Recall management"],
    color: "chart-5",
  },
]
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-16">
        ...
        <section className="container mx-auto px-4 mb-16">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold font-mono text-primary neon-text mb-6">Powerful Features</h1>
            <p className="text-xl text-muted-foreground mb-8">
              Comprehensive inventory management capabilities designed for modern businesses
            </p>
        ...
        <section className="container mx-auto px-4 mt-20">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Ready to Transform Your Inventory?</h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Experience the power of modern inventory management with all these features working seamlessly together.
            </p>
            <motion.button
