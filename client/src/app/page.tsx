...
import { ArrowRight, Shield, Zap, Users, BarChart3, CheckCircle, Star } from "lucide-react"
...
export default function HomePage() {
  const typedText = useTypingAnimation("NightShift Inventory Management System", 80)
        ...
        <section className="relative z-10 py-24 px-4">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl md:text-5xl font-bold font-mono text-primary mb-6">Why Choose NightShift?</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Experience the future of inventory management with our comprehensive platform designed for modern
                businesses.
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Real-time updates and instant synchronization across all your operations.",
                },
                {
                  icon: Users,
                  title: "Team Collaboration",
                  description: "Role-based access control with seamless team workflow management.",
                },
                {
                  icon: BarChart3,
                ...
                },
                {
                  icon: Star,
                  title: "24/7 Support",
                  description: "Round-the-clock customer support to keep your business running smoothly.",
                },
              ].map((feature, index) => (
                <motion.div
                  key={feature.title}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join thousands of businesses already using NightShift to streamline their operations and boost
                efficiency.
              </p>
              <motion.button
                className="inline-flex items-center gap-3 px-8 py-4 bg-primary text-primary-foreground rounded-lg font-semibold text-lg professional-hover shadow-lg"
...
function StatCard({ stat, delay }: { stat: (typeof stats)[0]; delay: number }) {
  ...
  return (
    ...
    >
      ...
      <div className="text-sm md:text-base text-muted-foreground font-medium tracking-wide">{stat.label}</div>
    </motion.div>
  )
}
